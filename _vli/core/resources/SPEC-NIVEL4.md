...
A implementação deve visar boa experiência de carregamento, interação e estabilidade visual. Trate Core Web Vitals e experiência de página como critérios técnicos relevantes de qualidade.
...
O anúncio e a página de destino precisam ser consistentes entre si. A qualidade da experiência no destino é parte crítica da performance de campanhas.

## 14.3 Transparência factual
Informações relevantes sobre a oferta não devem ficar excessivamente ocultas. A LP deve apresentar o produto com clareza, transparência e boa experiência de navegação.
